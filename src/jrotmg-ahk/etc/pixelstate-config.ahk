...
;;  hp bar positions
PixelState.PixelMapConfig("hp_100p", "steam", "fullscreen", 0.983, 0.426, 4292883508)
PixelState.PixelMapConfig("hp_75p", "steam", "fullscreen", 0.929, 0.426, 4292883508)
PixelState.PixelMapConfig("hp_50p", "steam", "fullscreen", 0.873, 0.426, 4292883508)
PixelState.PixelMapConfig("hp_25p", "steam", "fullscreen", 0.819, 0.426, 4292883508)
PixelState.PixelMapConfig("hp_0p", "steam", "fullscreen", 0.766, 0.426, 4292883508)
...
;;  chat box top line
PixelState.PixelMapConfig("chatbox_top1", "steam", "fullscreen", 0.000, 0.9667, 4294967295, false, 5)
PixelState.PixelMapConfig("chatbox_top2", "steam", "fullscreen", 0.125, 0.9667, 4294967295, false, 5)
PixelState.PixelMapConfig("chatbox_top3", "steam", "fullscreen", 0.250, 0.9667, 4294967295, false, 5)
PixelState.PixelMapConfig("chatbox_top4", "steam", "fullscreen", 0.375, 0.9667, 4294967295, false, 5)

;;  chat box bottom line
PixelState.PixelMapConfig("chatbox_bottom1", "steam", "fullscreen", 0.000, 0.9963, 4294967295, false, 5)
PixelState.PixelMapConfig("chatbox_bottom2", "steam", "fullscreen", 0.125, 0.9963, 4294967295, false, 5)
PixelState.PixelMapConfig("chatbox_bottom3", "steam", "fullscreen", 0.250, 0.9963, 4294967295, false, 5)
PixelState.PixelMapConfig("chatbox_bottom4", "steam", "fullscreen", 0.375, 0.9963, 4294967295, false, 5)

;;  chat box l/r sides
PixelState.PixelMapConfig("chatbox_side1", "steam", "fullscreen", 0.0000, 0.9731, 4294967295, false, 5)
PixelState.PixelMapConfig("chatbox_side2", "steam", "fullscreen", 0.7474, 0.9731, 4294967295, false, 5)

;;  chat box often obstructed pixels
PixelState.PixelMapConfig("chatbox_top6", "steam", "fullscreen", 0.700, 0.9667, 4294967295, false, 5)

;;  vertical black border separating the game from right column
PixelState.PixelMapConfig("controlpoint75_1", "steam", "fullscreen", 0.7495, 0.100, 4278190081, 0, 0)
PixelState.PixelMapConfig("controlpoint75_2", "steam", "fullscreen", 0.7495, 0.250, 4278190081, 0, 0)
PixelState.PixelMapConfig("controlpoint75_3", "steam", "fullscreen", 0.7495, 0.400, 4278190081, 0, 0)
PixelState.PixelMapConfig("controlpoint75_4", "steam", "fullscreen", 0.7495, 0.550, 4278190081, 0, 0)
PixelState.PixelMapConfig("controlpoint75_5", "steam", "fullscreen", 0.7495, 0.700, 4278190081, 0, 0)
PixelState.PixelMapConfig("controlpoint75_6", "steam", "fullscreen", 0.7495, 0.850, 4278190081, 0, 0)
PixelState.PixelMapConfig("controlpoint75_7", "steam", "fullscreen", 0.7495, 0.950, 4278190081, 0, 0)
